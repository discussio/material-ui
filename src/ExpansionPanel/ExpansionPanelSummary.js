...
export type Props = {
   ...
   */
  children?: Element<*>, // $ReadOnlyArray<ChildrenArray<*>>,
  /**
  ...
  expandIcon?: Element<*>,
  /**
   * Callback fired on every expand/collapse change.
   */
  onChange?: Function,
};
...
class ExpansionPanelSummary extends React.Component<AllProps, State> {
  ...
  render() {
    const { children, classes, disabled, expanded, expandIcon, onChange, ...other } = this.props;
